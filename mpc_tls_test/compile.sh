...
echo "compile client"
g++  -ggdb3 client.cpp   -L../build/mpc_tls -L/usr/local/lib -L../../install_openssl/lib -lotls -lemp-tool -lssl -lcrypto -pthread -ldl -o client -I../ -I../../install_openssl/include
echo "compile pado"
g++ -ggdb3 pado.cpp  -L../build/mpc_tls -L/usr/local/lib -L../../install_openssl/lib -lotls -lemp-tool -lssl -lcrypto -pthread -ldl -o pado -I../ -I../../install_openssl/include
