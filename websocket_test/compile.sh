...
em++ https_client.cpp  os.cpp -o https_client.html -g -lssl -lcrypto -ldl -lwebsocket.js -sWASM=1 -sERROR_ON_UNDEFINED_SYMBOLS=1 -sPROXY_POSIX_SOCKETS -sUSE_PTHREADS -sPROXY_TO_PTHREAD -sMAIN_MODULE -sREVERSE_DEPS=all --preload-file ca.crt -I${EMOPENSSL}/include -L${EMOPENSSL}/lib/
em++ binance_client.cpp  os.cpp -o binance_client.html -g -lssl -lcrypto -ldl -lwebsocket.js -sWASM=1 -sERROR_ON_UNDEFINED_SYMBOLS=1 -sPROXY_POSIX_SOCKETS -sUSE_PTHREADS -sPROXY_TO_PTHREAD -sMAIN_MODULE -sREVERSE_DEPS=all --preload-file binance.crt -I${EMOPENSSL}/include -L${EMOPENSSL}/lib/
